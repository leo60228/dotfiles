...
with import ../components; rec {
  components = efi en_us est extra { graalvm = true; } gui { autoLogin = true; } kde steam docker home { deviceScaleFactor = 2; } kvm glances flatpak prometheus ibus apcupsd { timeout = 300; minutes = 15; batteryLevel = 50; prometheus = "100.70.195.127"; } tailscale postgres mosh usbmuxd nixbuild firefox kdeconnect fwupd;
