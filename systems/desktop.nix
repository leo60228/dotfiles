...
with import ../components; rec {
  components = efi en_us est extra gui { autoLogin = true; } kde steam docker home kvm glances flatpak mqtt cross wg prometheus anbox ibus apcupsd { timeout = 300; minutes = 15; batteryLevel = 50; prometheus = "10.100.0.2"; } tpm2 tailscale postgres;
