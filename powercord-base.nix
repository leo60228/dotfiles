...
in stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    mkdir -p $out/opt/${binaryName}/resources/app
    echo 'require(`/home/leo60228/powercord/injectors/../src/patcher.js`)' > $out/opt/${binaryName}/resources/app/index.js
    echo '{"main":"index.js"}' > $out/opt/${binaryName}/resources/app/package.json
  '';
